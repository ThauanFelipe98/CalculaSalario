function salario(){
    ...
    document.getElementById('salario_atual').innerHTML = 'Informe o salario atual:' + salario_atual;
    ...
    document.getElementById('novo_salario').innerHTML = 'Valor salario, após o aumento R$:' + novo_salario;
